...
import styles from './things_to_do.module.css';
...
const RestaurantRegistrationForm: React.FC = () => {
  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      case 1:
        return !!(formData.PublisherName &&  formData.phoneNumber && formData.emailAddress && formData.businessType);
      case 2:
      ...
      <div className={styles.container}>
        <div className={styles.successWrapper}>
          ...
          <p className={styles.successMessage}>
            Congratulations! Your restaurant <strong>{formData.PublisherName}</strong> has been successfully registered in our system.
          </p>
            ...
            <div className={styles.step}>
              ...
              <div className={styles.row}>
                <div className={styles.field}>
                  <label htmlFor="PublisherName" className={styles.label}>Publisher Name *</label>
                  <input
                    type="text"
                    id="PublisherName"
                    name="PublisherName"
